    ...
    <>
      ...
      <ComposerPrimitive.Unstable_TriggerPopoverRoot>
        ...
        <div
          className={cn(
            'z-30 flex flex-col',
            // Classic Gold: dock the composer above the status bar (see styles.css --composer-dock-offset).
            poppedOut
              ? 'fixed max-w-[calc(100vw-1.5rem)]'
              : 'absolute bottom-[var(--composer-dock-offset)] left-1/2 max-w-full -translate-x-1/2'
          )}
...
export function ChatBarFallback() {
  return (
    <div
      className={cn(
        'group/composer absolute bottom-[var(--composer-dock-offset)] left-1/2 z-30 w-[min(var(--composer-width),calc(100%-2rem))] max-w-full -translate-x-1/2 rounded-2xl pt-2 pb-[var(--composer-shell-pad-block-end)]',
